...
export default function Video({data}) {
    return <Link 
        href={`videos/${data.hash}`} 
        className="relative w-64 mx-auto sm:w-[unset] sm:mx-[unset] h-48 bg-gray-100 rounded cursor-pointer shadow"
        style={ data.thumbnail_url ? { background: `url('${data.thumbnail_url}')`, backgroundSize: 'cover'} : {} }
    >
